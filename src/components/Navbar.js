...
export default function Navbar() {
  return (
    <div className="fixed z-50 bg-dark-500 w-full top-0 left-0 px-8 py-4 lg:px-20 xl:px-36 bg-opacity-25">
      <div className="flex justify-between items-center text-white">
        ...
        <a
          href="https://drive.google.com/file/d/1CCLLW0fkTYgcTJvzNzcs96cSUOdK-PyE/view"
          rel="noreferrer"
          target="_blank"
